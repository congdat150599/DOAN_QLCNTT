   ...
   class product
   {
       ...
       public function show_slider_admin(){
        ...
        public function getLastestBrand1(){
          $query = "SELECT * FROM tbl_product, tbl_brand WHERE tbl_brand.brandId = tbl_product.brandId AND tbl_product.brandId = '6' ORDER BY tbl_product.productId DESC LIMIT 1";
          $result = $this->db->select($query);
          return $result;
        }
        public function getLastestBrand2(){
          $query = "SELECT * FROM tbl_product, tbl_brand WHERE tbl_brand.brandId = tbl_product.brandId AND tbl_product.brandId = '7' ORDER BY tbl_product.productId DESC LIMIT 1";
          $result = $this->db->select($query);
          return $result;
        }
        public function getLastestBrand3(){
          $query = "SELECT * FROM tbl_product, tbl_brand WHERE tbl_brand.brandId = tbl_product.brandId AND tbl_product.brandId = '8' ORDER BY tbl_product.productId DESC LIMIT 1";
          $result = $this->db->select($query);
          return $result;
        }
        public function getLastestBrand4(){
          $query = "SELECT * FROM tbl_product, tbl_brand WHERE tbl_brand.brandId = tbl_product.brandId AND tbl_product.brandId = '9' ORDER BY tbl_product.productId DESC LIMIT 1";
          $result = $this->db->select($query);
          return $result;
        }
